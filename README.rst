...
---------------------------------
Registering ckanext-eaw_theme on PyPI
---------------------------------

ckanext-eaw_theme should be availabe on PyPI as
https://pypi.python.org/pypi/ckanext-eaw_theme. If that link doesn't work, then
...
ckanext-eaw_theme is availabe on PyPI as https://pypi.python.org/pypi/ckanext-eaw_theme.
